...
public:
  ...
  uint8_t getFlightState() {return flight_state_;}

  BLA::Matrix<3, 1> getTargetPos() {return target_pos_;}
  ...
  void setTargetRoll(float target_roll) {target_rpy_(0) = target_roll;}
  void setTargetPitch(float target_pitch) {target_rpy_(1) = target_pitch;}
  void setTargetYaw(float target_yaw) {target_rpy_(2) = target_yaw;}
