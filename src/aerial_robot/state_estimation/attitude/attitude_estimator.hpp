...
public:
  ...
  BLA::Matrix<3, 1> getFilteredAcc() {return filtered_acc_;}
  float getFilteredAccX(){return filtered_acc_(0);}
  float getFilteredAccY(){return filtered_acc_(1);}
  float getFilteredAccZ(){return filtered_acc_(2);}
